...
string objFile = "../models/SuzanneTriTextured.obj", mtlFile = "../materials/SuzanneTriTextured.mtl", curvesFile = "../curva.txt";
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Tarefa M6 -- Artur Palagi!", nullptr, nullptr);
